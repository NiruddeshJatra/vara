      ...
      <DialogContent className="max-w-3xl bg-gradient-to-b from-white to-lime-50 p-8">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-1/2 space-y-3">
            <h2 className="text-2xl font-bold text-green-800">{selectedItem.name}</h2>
            <div className="flex items-center">
              <Star className="h-4 w-4 text-yellow-500 fill-yellow-500" />
              <span className="ml-1 text-sm font-medium">{selectedItem.rating}</span>
              <span className="ml-1 text-xs text-gray-500">({selectedItem.reviewCount} reviews)</span>
            </div>
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-500 mt-1">$100 security deposit required</p>
            ...
            <div>
              <h3 className="font-medium mb-2 text-green-900">Description</h3>
