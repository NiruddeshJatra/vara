      ...
      <div className="space-y-6">
        <div>
          ...
          >
            <SelectTrigger className={errors.purpose ? 'border-red-500' : ''}>
              {formData.purpose ? PURPOSE_OPTIONS.find(opt => opt.value === formData.purpose)?.label : 'Select purpose'}
            </SelectTrigger>
            <SelectContent>
        ...
        <div className="bg-gradient-to-r from-amber-50 to-amber-100 p-4 rounded-lg border border-amber-200 mt-4">
          ...
          <ul className="text-sm text-amber-700 space-y-1 list-disc pl-5">
            <li>Please provide accurate details to help us process your request faster</li>
            <li>Additional notes help the owner understand your needs better</li>
            <li>You'll be able to communicate with the owner after your request is approved</li>
          </ul>
        </div>
      </div>
