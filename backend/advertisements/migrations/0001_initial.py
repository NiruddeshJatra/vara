    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('security_deposit', models.DecimalField(decimal_places=2, default=0.0, help_text='Security deposit required for rental', max_digits=10)),
                ('purchase_year', models.CharField(help_text='Year product was purchased (YYYY)', max_length=4, validators=[django.core.validators.FileExtensionValidator(['jpg', 'jpeg', 'png'])])),
                ('original_price', models.DecimalField(decimal_places=2, help_text='Original price of the product', max_digits=10)),
                ('ownership_history', models.CharField(choices=[('firsthand', 'First Hand'), ('secondhand', 'Second Hand')], help_text='Ownership history of the product', max_length=50)),
                ('status', models.CharField(choices=[('draft', 'Draft - Pending Review'), ('active', 'Active - Available for Rent'), ('maintenance', 'Under Maintenance - Needs Action'), ('suspended', 'Suspended - Listing Disabled')], default='draft', help_text='Current status of the product', max_length=20)),
                ('status_message', models.CharField(blank=True, help_text='Status message for the product', max_length=255)),
                ('status_changed_at', models.DateTimeField(blank=True, help_text='Timestamp when status last changed', null=True)),
                ...
                ('average_rating', models.DecimalField(decimal_places=2, default=0.0, help_text='Average rating of the product', max_digits=3)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
